...
public abstract class MemorySegment {
     ...
     *         data between the index and the memory segment end is not enough to fill the
     *         destination
     *         array.
     */
     ...
     *
     * @throws IndexOutOfBoundsException Thrown, if the index is negative, or too large that the
     *         requested number of bytes exceed the amount of memory between the index and the
     *         memory
     *         segment's end.
     */
     ...
     *
     * @throws IndexOutOfBoundsException Thrown, if the index is negative, or too large such that
     *         the array portion to copy exceed the amount of memory between the index and the
     *         memory
     *         segment's end.
     */
     ...
     *         the given number of bytes (starting from offset), or the target byte buffer does
     *         not have
     ...
     *         does not contain the given number of bytes (starting from offset), or the target
     *         segment
