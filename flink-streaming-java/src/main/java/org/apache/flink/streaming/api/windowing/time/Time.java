...
/**
 * 窗口时间间隔的定义。所指的时间特性是在执行环境中设置的默认时间特性。
 *
...
public final class Time {
    ...
    /**
     * 创建给定持续时间和 {@link TimeUnit} 的新 {@link Time}。
     *
     * <p>{@code Time} 是指通过
